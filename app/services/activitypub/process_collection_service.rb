...
class ActivityPub::ProcessCollectionService < BaseService
  ...
  class ProcessItem
    ...
    def process_mention(tag, status)
      account = Account.find_by(uri: tag['href']) # FIXME: Resolve unknown accounts
    ...
    def process_attachments(status)
      ...
      do_not_download = DomainBlock.find_by(domain: status.account.domain)&.reject_media?
    ...
    def visibility_from_audience
      if @object['to'].include? ActivityPub::TagManager::COLLECTIONS[:public]
        :public
      elsif @object['cc'].include? ActivityPub::TagManager::COLLECTIONS[:public]
        :unlisted
      else
